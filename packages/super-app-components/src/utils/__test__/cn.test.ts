...
describe('cn', () => {
  it('combine classes correctly', () => {
    expect(cn('text-lg', 'text-center')).toBe('text-lg text-center')
  })

  it('merge conflicting classes', () => {
