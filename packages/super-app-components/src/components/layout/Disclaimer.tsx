...
export default function DisclaimerModal() {
  ...
  return (
    <Modal
      ...
      footer={null}
      width={500}
      className="[&_.ant-package-modal-content]:!bg-[#171819] [&_.ant-package-modal-content]:!text-white [&_.ant-package-modal-content]:!rounded-[16px] [&_.ant-package-modal-content]:!border [&_.ant-package-modal-content]:!border-white/10 h-[600px] w-[500px]"
    >

      <h2 className="text-[#CEFF70] text-lg/[1.5] font-semibold mb-6">
        Disclaimer & Terms of Service
      </h2>
      <div className="flex flex-col gap-5">
        <div className="relative h-[342px]">
          <div className="h-full overflow-y-auto pr-4 scroller">
            <p className="text-[15px]/[1.5] font-normal whitespace-pre-line">
              {terms}
            </p>
          </div>
        ...
        <p className="text-base leading-[1.5] italic font-normal">
          By clicking accept, you here by acknowledge that you have read and accept the{" "}
          <a
            className="text-[#CEFF70] font-bold italic underline"
        ...
        <Button
          type="primary"
          block
          className="!bg-[#CEFF70] !text-[#072B09] !font-medium !text-base !rounded-lg !py-3 !h-fit hover:!bg-[#b8e65c] "
